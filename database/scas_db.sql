...
CREATE TABLE IF NOT EXISTS registrations (
  ...
  club_id INT,
  image VARCHAR(255),
  FOREIGN KEY (club_id) REFERENCES club_list(id)
);
...
--   PRIMARY KEY (id),
--   KEY club_id (club_id),
--   CONSTRAINT application_club_id_fk FOREIGN KEY (club_id) REFERENCES club_list (id) ON DELETE CASCADE ON UPDATE NO ACTION
-- );

-- CREATE TABLE IF NOT EXISTS club_list (
--   id INT NOT NULL AUTO_INCREMENT,
--   name TEXT NOT NULL,
--   description TEXT NOT NULL,
--   status TINYINT(1) NOT NULL DEFAULT 1,
...
--   PRIMARY KEY (id),
--   KEY club_id (club_id),
--   CONSTRAINT user_club_id_fk FOREIGN KEY (club_id) REFERENCES club_list (id) ON DELETE SET NULL ON UPDATE NO ACTION
-- );
