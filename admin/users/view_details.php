        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                ...
                <dl class="row">
                    ...
                    <dt class="col-3 px-2">Student ID</dt>
                    <dd class="col-9 px-2"><p class="mb-0"><?= isset($student_id) ? $student_id : '' ?></p></dd>
                    <dt class="col-3 px-2">Gender</dt>
                    <dd class="col-9 px-2"><p class="mb-0"><?= isset($gender) ? $gender : '' ?></p></dd>
                    <dt class="col-3 px-2">Batch</dt>
                    <dd class="col-9 px-2"><p class="mb-0"><?= isset($year_level) ? $year_level : '' ?></p></dd>
                    <dt class="col-3 px-2">Degree</dt>
                    <dd class="col-9 px-2"><p class="mb-0"><?= isset($grade) ? $grade : '' ?></p></dd>
