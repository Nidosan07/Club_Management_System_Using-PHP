        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12">
                <form action="" id="user-form" class="py-3">
                    ...
                    <div class="input-group mb-3 input-group-dynamic <?= isset($student_id) ? 'is-filled' : '' ?>">
                        <label for="student_id" class="form-label">Student ID</label>
                        <input type="text" id="student_id" name="student_id" value="<?= isset($student_id) ? $student_id : "" ?>" class="form-control">
                    </div>
                    <div class="row mb-2">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="input-group mb-3 input-group-dynamic <?= isset($year_level) ? 'is-filled' : '' ?>">
                        <label for="year_level" class="form-label">Batch <span class="text-danger">*</span></label>
                        <input type="text" id="year_level" name="year_level" value="<?= isset($year_level) ? $year_level : "" ?>" class="form-control">
                    </div>
                    <div class="input-group mb-3 input-group-dynamic <?= isset($grade) ? 'is-filled' : '' ?>">
                        <label for="grade" class="form-label">Degree <span class="text-danger">*</span></label>
                        <input type="text" id="grade" name="grade" value="<?= isset($grade) ? $grade : "" ?>" class="form-control">
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <select name="type" id="type" class="form-select rounded-0" required>
                            ...
                            <option class="px-2 py-2" value="3" <?= isset($type) && $type == 3 ? 'selected': '' ?>>Student</option>
...
<script>
    ...
    $(function(){
        ...
        // Check if the selected type is a student (Type 3)
        if(type == 3){
            // Disable or hide elements relevant to non-students
            $('#club-field').addClass('d-none');
            $('#club_id').removeAttr('required');
        } else {
            // Enable or show elements relevant to students
            $('#club-field').removeClass('d-none');
            $('#club_id').attr('required', true);
        }
    })
