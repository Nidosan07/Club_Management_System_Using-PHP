    ...
    <div class="container">
        ...
        <form action="" id="application-form">
            ...
            <div class="row mb-2">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group mb-3 input-group input-group-dynamic">
                        <label class="form-label" for="year_level">Batch <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" required="required" id="year_level" name="year_level">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <div class="form-group mb-3 input-group input-group-dynamic">
                        <label class="form-label" for="section">Degree <span class="text-danger">*</span></label>
