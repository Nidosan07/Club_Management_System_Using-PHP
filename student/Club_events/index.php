                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><b>Event Date: </b><?php echo $row["event_date"]; ?></small></p>

                                    <!-- Action buttons -->
                                    <div class="d-grid">
                                    <button class="btn btn-danger btn-sm" type="button" onclick="confirmDelete()">Register</button>
...
<script>
    function confirmDelete() {
            ...
            window.location.href = "./?page=register/"; // Replace "your_redirect_page.php" with the desired page URL
        }
